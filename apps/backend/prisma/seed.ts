...
async function main() {
  ...
  await prisma.file.createMany({
    data: [
      ...
      { name: "mri-brain-001.jpg", size: 4194304n, mimeType: "image/jpeg", folderId: radiologi.id },
      { name: "ct-scan-chest-001.jpg", size: 3670016n, mimeType: "image/jpeg", folderId: radiologi.id },
      ...
      { name: "ekg-result-001.jpg", size: 1572864n, mimeType: "image/jpeg", folderId: spJantung.id },
      { name: "ekg-result-002.jpg", size: 1835008n, mimeType: "image/jpeg", folderId: spJantung.id },
      { name: "usg-kandungan-001.jpg", size: 2831152n, mimeType: "image/jpeg", folderId: spKandungan.id },
      { name: "usg-kandungan-002.jpg", size: 2621440n, mimeType: "image/jpeg", folderId: spKandungan.id },
      { name: "presentasi-rapat-medis.pptx", size: 1048576n, mimeType: "application/vnd.openxmlformats-officedocument.presentationml.presentation", folderId: dokterUmum.id },
      { name: "sop-keperawatan.pdf", size: 245760n, mimeType: "application/pdf", folderId: keperawatan.id },
      { name: "jadwal-shift.xlsx", size: 87000n, mimeType: "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", folderId: keperawatan.id },
      { name: "video-prosedur-operasi.mp4", size: 15728640n, mimeType: "video/mp4", folderId: dokterSpesialis.id },
      { name: "audio-rekaman-pasient.mp3", size: 5242880n, mimeType: "audio/mpeg", folderId: rekamMedis.id },
      { name: "backup-data.zip", size: 10485760n, mimeType: "application/zip", folderId: admin.id },
      { name: "config.json", size: 2048n, mimeType: "application/json", folderId: admin.id },
      { name: "catatan.txt", size: 1024n, mimeType: "text/plain", folderId: dokterUmum.id },
      { name: "foto-wajah-pasien.png", size: 2097152n, mimeType: "image/png", folderId: rekamMedis.id },
    ],
  })
